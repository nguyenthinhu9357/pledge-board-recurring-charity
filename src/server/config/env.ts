...
const envSchema = z.object({
  ...
  NEXT_PUBLIC_APP_NAME: z.string().default('Janji'),
  NEXT_PUBLIC_APP_URL: z.string().url().default('http://localhost:3001'),

  DRIZZLE_DATABASE_URL: z.string().url().default('postgres://demo:demo@localhost:5432/janji'),
  ...
  SESSION_SECRET: z
    ...
    .default('janji-public-demo-session-secret-2026'),
  SESSION_COOKIE_NAME: z.string().default('janji_session'),
